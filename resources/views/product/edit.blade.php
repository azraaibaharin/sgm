...
@section('content')
<form class="form-horizontal bottom-margin-sm" role="form" method="POST" action="{{ url('products/'.session('id').'/edit') }}" enctype="multipart/form-data">
    {{ csrf_field() }}
    <div class="container">
        <div class="row">
        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                @include('shared.form.back', ['link' => 'products/'.session('id')])
