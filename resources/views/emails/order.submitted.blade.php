...
<p>
	...
	<label>Reference no:</label> {{ $order->reference_number }}
	<label>Status:</label> {{ $order->reference_number }}
	<label>Name:</label> {{ $order->name }}
	<label>Email:</label> {{ $order->email }}
	<label>Phone number:</label> {{ $order->phone_number }}
