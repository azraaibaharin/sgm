...
@section('content')
<form class="form-horizontal bottom-margin-sm" role="form" method="POST" action="{{ url('articles/'.$id.'/edit') }}" enctype="multipart/form-data">
    {{ csrf_field() }}
    <div class="container">
        <div class="row">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group{{ $errors->has('link') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-9">
                                <input id="link" class="form-control" name="link" value="{{ old('link') ? old('link') : $link }}" />
                        ...
                        <div class="form-group{{ $errors->has('author') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-9">
                                <input id="author" class="form-control" name="author" value="{{ old('author') ? old('author') : $author }}" required />
